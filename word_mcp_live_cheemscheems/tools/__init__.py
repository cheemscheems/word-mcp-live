...
# Document tools
from word_mcp_live_cheemscheems.tools.document_tools import (
...
# Format tools
from word_mcp_live_cheemscheems.tools.format_tools import (
    format_text, create_custom_style, format_table
)

# Protection tools
from word_mcp_live_cheemscheems.tools.protection_tools import (
    protect_document, add_restricted_editing,
    add_signature_block, verify_document
)

# Footnote tools
from word_mcp_live_cheemscheems.tools.footnote_tools import (
    add_footnote_to_document, add_endnote_to_document,
    convert_footnotes_to_endnotes_in_document, customize_footnote_style
)

# Comment tools
from word_mcp_live_cheemscheems.tools.comment_tools import (
    get_all_comments, get_comments_by_author, get_comments_for_paragraph
)

# Comment write tools
from word_mcp_live_cheemscheems.tools import comment_write_tools
